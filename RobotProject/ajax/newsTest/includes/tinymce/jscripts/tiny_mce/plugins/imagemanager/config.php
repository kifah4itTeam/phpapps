<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,docx,doc,xls,xlsx,pdf,html,pptx,ppt";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,docx,doc,xls,xlsx,pdf,html,pptx,ppt";
	...
	$mcImageManagerConfig['upload.autoresize_jpeg_quality'] = 100; // Force max width/height, IM will rescale uploaded images.
	$mcImageManagerConfig['upload.max_width'] = "960"; // Only if force_width_height is true
